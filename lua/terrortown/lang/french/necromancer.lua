...
L["necrodefi_player_already_reviving"] = "Le joueur est déjà réanimé"
...
L["necrodefi_error_no_valid_ply"] = "Vous ne pouvez pas réanimer ce joueur car son corps n'existe pas ou n'est pas valide."
